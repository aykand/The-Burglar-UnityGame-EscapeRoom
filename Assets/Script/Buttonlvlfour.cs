...
public class Buttonlvlfour : MonoBehaviour
{
    private DisplayImageFour currentDisplay;

    private float FirstCameraSize;
    private Vector3 FirstCameraPosition;
    void Start()
    {
        currentDisplay = GameObject.Find("displayImage").GetComponent<DisplayImageFour>();
    ...
    public void ZoomOut()
    {
        GameObject.Find("displayImage").GetComponent<DisplayImageFour>().CurrentState = DisplayImageFour.State.normal;
